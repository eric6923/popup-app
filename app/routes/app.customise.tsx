...
const [locationRuleOption, setLocationRuleOption] = useState("any");
  ...
  const handleCountryRemove = useCallback((countryToRemove) => {
    const isExcludeMode = locationRuleOption === "exclude";
    if (isExcludeMode) {
  ...
  const activeCountries = locationRuleOption === "exclude" 
    ? excludedCountries 
    : selectedCountries;
            ...
            {selectedTab === 0 && (
              <>
                ...
                <div style={{
                  ...
                  <BlockStack gap="400">
                    <Text as="h2" variant="headingMd">Discount coupon</Text>
                    <Text as="p" variant="bodySm">Attract customers to subscribe with a discount code.</Text>
                    ...
                    <BlockStack gap="100">
                      ...
                      {discountOption === "discount-code" && (
                        <div style={{ paddingLeft: "26px" }}>
                          <BlockStack gap="300">
                            <Text variant="bodySm">Auto-generate a unique and non-reusable code for each subscription.</Text>
                            
                            <div>
                              <Text variant="bodySm" as="p">Select type</Text>
                              <Select
                                label=""
                                labelHidden
                            ...
                            {setExpiration && (
                              <div style={{ marginTop: "8px" }}>
                                <Text variant="bodySm" as="p">Expiration days</Text>
                                <div style={{ display: "flex", alignItems: "center" }}>
                                  <TextField
                                    type="number"
                ...
                <div style={{
                  ...
                  <BlockStack gap="300">
                    <Text as="h2" variant="headingMd">Sticky discount bar</Text>
                ...
                <div style={{
                  ...
                  <BlockStack gap="300">
                    <Text as="h2" variant="headingMd">Sidebar widget</Text>
                    <Text as="p" variant="bodySm">
                        ...
                        {triggerOption === "scroll" && (
                          <div style={{  marginTop: "4px" }}>
                            <InlineStack gap="100">
                              ...
                              <Text as="span" variant="bodySm">% of page</Text>
                            </InlineStack>
                          </div>
                        )}
                ...
                <div style={{
                  ...
                  <BlockStack gap="300">
                    ...
                    <Text as="p" variant="bodySm">
                      Number of times the popup will show on browser for non-subscribed customers based on selected time.
                    </Text>
                    ...
                    <BlockStack gap="100">
                      ...
                      {frequencyOption === "limit" && (
                        <InlineStack gap="200" align="center" wrap={false}>
                          <Text as="span" variant="bodyMd">Limit:</Text>
                          ...
                          <Text as="span" variant="bodyMd">Per:</Text>
                ...
                <div style={{
                  ...
                  <BlockStack gap="300">
                    <Text as="h2" variant="headingMd">PAGE RULES</Text>
                    <Text as="p" variant="bodySm">
                    ...
                    <BlockStack gap="100">
                      ...
                      {pageRuleOption === "specific" && (
                        <BlockStack gap="400">
                          ...
                          <div>
                            <Text as="p" variant="bodySm">Page path:</Text>
              ...
              <BlockStack gap="200">
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '8px' }}>
                  {selectedCountries.map((country) => {
                    const countryLabel = allCountries.find(option => option.value === country)?.label || country;
                    return (
...
<div style={{
  ...
  <BlockStack gap="300">
    <Text as="h2" variant="headingMd">SCHEDULE RULES</Text>
      ...
      {scheduleOption === "time-period" && (
        <div style={{ paddingLeft: "26px", marginTop: "8px" }}>
          <BlockStack gap="400">
            {/* Start date and time */}
            <BlockStack gap="300">
              <Text variant="bodySm" as="p">Start date</Text>
              <div style={{ display: "flex", gap: "16px" }}>
                ...
                <div style={{ flex: 1 }}>
                  <Text variant="bodySm" as="p">Start time (EDT)</Text>
                  <TextField
                    value={startTime}
            ...
            {hasEndDate && ( // Changed variable name
              <BlockStack gap="300">
                <Text variant="bodySm" as="p">End date</Text>
                <div style={{ display: "flex", gap: "16px" }}>
                  <div style={{ flex: 1 }}>
                    <TextField
                      value={endDate}
                  ...
                  <div style={{ flex: 1 }}>
                    <Text variant="bodySm" as="p">End time (EDT)</Text>
                    <TextField
                      value={endTime}
          ...
          {/* Right Panel - Preview */}
          <div style={{ flex: 1, backgroundColor: "#f6f6f7", padding: "16px", display: "flex", flexDirection: "column" }}>
            {/* Device toggle */}
            <div style={{ 
              display: "flex", 
